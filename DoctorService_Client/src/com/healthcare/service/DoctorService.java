...
public class DoctorService {
	...
	public String insertDoctor(String doctorData) {
		...
		String output = doctorObj.insertDoctor(docID, dName, address, contactNumber, speciality, description,
				docCharges, visitingHospitals);
	...
	public String updateDoctor(String doctorData) {
		...
		String output = doctorObj.updateDoctor(docNo, docID, dName, address, contactNumber, speciality, description,
				docCharges, visitingHospitals);
